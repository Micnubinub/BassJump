...
public class GameHelper implements GoogleApiClient.ConnectionCallbacks,
    ...
    private final int mMaxAutoSignInAttempts = DEFAULT_MAX_SIGN_IN_ATTEMPTS;
    // Api options to use when adding each API, null for none
    private final GamesOptions mGamesApiOptions = GamesOptions.builder().build();
    private final PlusOptions mPlusApiOptions = null;
    // --Commented out by Inspection (27/10/14 11:00 PM):NoOptions mAppStateApiOptions = null;
    // Should we show error dialog boxes?
    private final boolean mShowErrorDialogs = true;
...
// --Commented out by Inspection START (27/10/14 11:00 PM):
//    /**
...
//    }
// --Commented out by Inspection STOP (27/10/14 11:00 PM)
...
// --Commented out by Inspection STOP (27/10/14 11:00 PM)
    ...
    public static void log(String cause) {
        Log.e("gameHelper", cause);
    }
...
// --Commented out by Inspection STOP (27/10/14 11:00 PM)
     ...
     */
    GoogleApiClient.Builder createApiClientBuilder() {
        if (mSetupDone) {
...
// --Commented out by Inspection STOP (27/10/14 11:00 PM)
    ...
    public void beginUserInitiatedSignIn() {
        log("begin user initiated sign in");
    ...
    int incrementSignInCancellations() {
        ...
        final SharedPreferences.Editor editor = mAppContext.getSharedPreferences(
                GAMEHELPER_SHARED_PREFS, Context.MODE_PRIVATE).edit();
        editor.putInt(KEY_SIGN_IN_CANCELLATIONS, cancellations).commit();
    ...
    void resetSignInCancellations() {
        final SharedPreferences.Editor editor = mAppContext.getSharedPreferences(
                GAMEHELPER_SHARED_PREFS, Context.MODE_PRIVATE).edit();
        editor.putInt(KEY_SIGN_IN_CANCELLATIONS, 0).commit();
    }
